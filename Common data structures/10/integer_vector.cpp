...
void IntegerVectorCustomerPrint( const IntegerVector & _vector, std::ostream & _stream)
{
	int index = 0;
	//выводим элементы после 5 введенного
	while (index < _vector.m_nUsed - 5) _stream << _vector.m_pData[index++] << std::endl;
}
