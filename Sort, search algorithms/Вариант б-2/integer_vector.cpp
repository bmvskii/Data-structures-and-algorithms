...
void IntegerVectorIsArith(const IntegerVector & _v)
{
	int difference = _v.m_pData[1] - _v.m_pData[0];
	for (int i = 0; i < _v.m_nUsed - 1; i++)
		if (_v.m_pData[i + 1] - _v.m_pData[i] != difference)
		{
