...
unsigned int HashCode (  double _key )
{
    unsigned int hashCode = (unsigned int)_key;
    return hashCode;
}


bool HashTableTryInsertElement ( HashTable & _ht, int _bucketNr, double _key, double _value )
{
