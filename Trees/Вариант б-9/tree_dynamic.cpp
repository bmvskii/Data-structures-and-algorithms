...
void TreeDirectWalk(TreeNode * _pNode, TreeNodeVisitFunction _f)
{
	(*_f)(*_pNode);
...
void TreeReverseWalk(TreeNode * _pNode, TreeNodeVisitFunction _f)
{
	TreeNode * pChild = _pNode->m_pLeftMostChild;
	while (pChild)
	{
...
void TreeSymmetricWalk(TreeNode * _pNode, TreeNodeVisitFunction _f)
{
